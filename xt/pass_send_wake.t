...
# reqrep_pass_send_wake passes wakeups to waiting senders when room is available,
# even when a concurrent consumer advances req_head past a snapshotted req_tail.
