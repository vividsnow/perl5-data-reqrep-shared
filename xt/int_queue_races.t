...
# instructions of a copy of reqrep.h: the queue may lose only the message the
# killed process held, and must never wedge, duplicate or reorder.
...
my @rows = (
    ...
    [clear_mid_send   => qr/^sent=1 got=1 more=-1 laps=12$/, 'clear() while a sender has claimed but not published: it sends again and the queue works'],
