...
# A process killed while parked leaves its registration behind. Wakes must stop
# paying a system call for it: count FUTEX_WAKE calls in round trips after it.
